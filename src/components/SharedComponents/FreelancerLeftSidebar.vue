<template>
  <div>
    <div class="lg:hidden">
      <div class="fixed inset-0 flex z-40" v-show="openSecondMenu">
        <!-- <OpenSecondMenu v-on:secondMenuClicked="changeSecondMenu()" /> -->
        <!--
        ...
        Leaving: "transition-opacity ease-linear duration-300"
          ...
          To: "opacity-0"
        -->
        <div class="fixed inset-0" v-show="openSecondMenu">
        ...
        Leaving: "transition ease-in-out duration-300 transform"
          ...
          To: "-translate-x-full"
        -->
        <div class="relative flex-1 flex flex-col max-w-xs w-full bg-white" v-show="openSecondMenu">
          <div class="absolute top-0 right-0 -mr-14 p-1">
            <button
              @click="changeSecondMenu()"
          ...
          <div class="flex-1 h-0 pt-5 pb-4 overflow-y-auto" v-show="openSecondMenu">
            <div class="uppercase text-sm font-bold text-blue-900 mb-2">Categories</div>
            <nav class="mt-5 px-2">
              <a
                href="#"
              ...
              <a
                href="#"
                class="mt-1 group flex items-center px-2 py-2 text-base leading-6 font-medium text-gray-600 rounded-md hover:text-gray-900 hover:bg-blue-60 focus:outline-none focus:text-gray-900 focus:bg-gray-100 transition ease-in-out duration-150"
              >
                <svg
