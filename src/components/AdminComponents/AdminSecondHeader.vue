<template>
  <div>
    ...
    <div class="hidden md:flex md:flex-shrink-0 h-full">
      <div class="flex flex-col w-280 bg-blue-800 pt-5 pb-4">
        <div class="flex items-center flex-shrink-0 px-4">
          <img class="h-6 w-auto" src="@/assets/free-lancer-logo.svg" alt="Workflow" />
        </div>
        <div class="mt-5 h-0 flex-1 flex flex-col overflow-y-auto p-4">
          ...
          <ul class="flex flex-col w-full">
            <li class="my-px">
              <router-link
                to="/admin/home"
                href="#"
                class="flex flex-row items-center h-12 px-4 rounded-lg text-white bg-blue-900"
              >
            ...
            <li class="my-px">
              <span
                class="flex font-medium text-sm text-white px-4 mt-4 mb-2 uppercase"
              >User Management</span>
            </li>
            <li class="my-px">
              <router-link
                to="/admin/users"
                class="flex flex-row items-center h-12 px-4 rounded-lg text-white hover:bg-blue-700"
              >
...
export default {
  ...
  watch: {
    $route(to, from) {
      console.log(to.name + "path change" + from.name);
      this.openMenu = true;
