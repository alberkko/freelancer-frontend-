<template>
  <div class="max-w-screen-sxl mx-auto p-2 sm:p-6 lg:p-8 flex-1 relative">
    <div class>
      <div class>
    ...
    <div class="mt-8">
      ...
      <h2 class="mt-8 text-lg leading-6 font-medium text-cool-gray-900">Recent activity</h2>
      ...
      <div class="hidden sm:block">
        <div class>
          <div class="flex flex-col mt-2">
            <div
              class="align-middle min-w-full overflow-x-auto shadow-lg overflow-hidden sm:rounded-lg"
            >
