<template>
  <div class="h-screen flex justify-center">
    <div class="w-1/2 flex-col hh flex mt-16 pb-16 bg-white shadow rounded-lg items-center">
      <div class="mt-10">
        <svg
        ...
        >
          ...
          <polygon
            ...
            opacity="0.2"
          />
          <polygon points="694.59 3.35 656.63 70.34 713.31 19.31 694.59 3.35" fill="#0b6eff" />
          <polygon points="729.82 45.7 656.71 69.85 717.82 24.23 729.82 45.7" fill="#0b6eff" />
          <polygon
          ...
          <polygon
            ...
            opacity="0.2"
          />
          <polygon points="40.47 8.99 122.6 86.31 21.18 39.42 40.47 8.99" fill="#0b6eff" />
          <polygon points="9.49 83.51 122.28 85.67 16.99 48.27 9.49 83.51" fill="#0b6eff" />
        </svg>
      </div>
      <div class="ml-5 font-bold text-blue-600 text-2xl mt-10">Verify your email to proceed</div>
      <div class="mx-32 mt-10 text-center text-gray-600">
        We just sent an email to the address:
        <span class="font-bold">{{profileModel.email}}</span>
        <br />Please check your email and click on the link provided to verify your address.
      </div>
      <div
        @click="showEmailField = !showEmailField"
        class="mt-10 text-green-500 text-sm cursor-pointer"
      >Change email</div>
      <div v-show="showEmailField" class="mt-5 w-full">
        <div class="flex justify-center items-center w-full">
          <div class="text-xl w-1/3 leading-6 font-bold text-gray-900">
            <input
          ...
          <div
            class="text-sm bg-white text-green-500 py-2 mx-5 px-5 rounded border border-green-400 hover:bg-green-400 hover:text-white cursor-pointer"
          >Update and Resend</div>
        </div>
      </div>
      <div
        class="bg-green-400 text-white mt-10 py-2 px-5 rounded cursor-pointer hover:bg-green-500"
