<template>
  <div
    class="min-height flex lg:flex-row flex-col max-w-screen-sxl mx-auto p-2 sm:p-6 lg:p-8"
  >
    <LeftSidebar />
      ...
      <div class="flex flex-col w-0 flex-1 overflow-hidden">
        ...
        >
          <div class="p-2">
            ...
            <div
              class="mm h-64 text-sm flex justify-center text-gray-500"
              else
            ></div>
          </div>
        </div>
...
import MyProjectsCard from "@/components/SharedComponents/MyProjectsCard";
