<template>
  <div class="h-screen flex flex-col items-center">
    <div class="mt-10 w-1/3 bg-white rounded-lg">
      ...
      <div
        class="flex justify-center mt-24 text-lg text-green-400"
      >Thank you for your registration!</div>
      <div
        class="flex justify-center text-sm mt-5 text-green-400 mb-32"
      >Your email was registered successfully!</div>
    </div>
  </div>
</template>
