  ...
  <div class="pb-32">
    <div>
      <div class="bg-blue-800">
        <div class="max-w-screen-sxl mx-auto pb-16 py-4 px-4 sm:px-6 lg:py-16 lg:px-8">
          <div class="text-center">
            <div id="toolBtns">
              <div class="btn-group" role="group" id="toolBtns">
                <button
                  class="btn border-white border px-8 rounded-l py-1 text-white text-xl"
                  type="button"
                  @click="activeBtn = 'btn1'"
                  :class="{active: activeBtn === 'btn1' }"
                >Free-lancer</button>
                <button
                  class="btn border-white border px-8 rounded-r py-1 text-white text-xl"
                  type="button"
          ...
          <div class="relative lg:grid lg:grid-cols-10">
            ...
            >
              <div class="relative z-10 rounded-lg shadow-xl">
                <div>
                  <div
                    class="pointer-events-none absolute inset-0 rounded-lg border-4 border-yellow-200"
                  ></div>
                  <div class="absolute inset-x-0 top-0 transform translate-y-px">
                    <div class="flex justify-center transform -translate-y-1/2">
                      <span
                        class="inline-flex rounded-full bg-yellow-200 px-4 py-1 text-gray-900 text-sm leading-5 font-extrabold tracking-wider uppercase"
                  ...
                  <div class="bg-white rounded-t-lg px-6 pt-12 pb-10">
                    <div>
                      <p
                        class="text-center text-lg leading-7 font-bold font-display text-blue-500 uppercase tracking-widest"
                      >Prefered</p>
                      <h2
                  ...
                  >
                    <ul class="lg:py-12">
                      <li class="flex items-start">
                        ...
                        <p class="ml-3 text-base leading-6 font-medium text-gray-500">30 bids</p>
                      </li>
                      <li class="mt-4 flex items-start">
                        ...
                        <p class="ml-3 text-base leading-6 font-medium text-gray-500">50 skills</p>
                      </li>
                      <li class="mt-4 flex items-start">
                        <div class="flex-shrink-0">
                          <svg
                        ...
                        <p class="ml-3 text-base leading-6 font-medium text-gray-500">1 Featured Bid</p>
                      </li>
                    </ul>
                    <div class="mt-10">
                  ...
                  >
                    <ul>
                      <li class="flex items-start">
                        ...
                        <p class="ml-3 text-base leading-6 font-medium text-gray-500">10 bids</p>
                      </li>
                      <li class="mt-4 flex items-start">
                        <div class="flex-shrink-0">
                          <svg
                        ...
                        <p class="ml-3 text-base leading-6 font-medium text-gray-500">20 skills</p>
                      </li>
                    </ul>
                    <div class="mt-8">
                      <div class="border-2 border-blue-900 rounded-lg shadow-md">
                        <a
                          data-gumroad-single-product="true"
                          class="block w-full text-center rounded-lg bg-white px-6 py-3 text-base leading-6 font-bold font-display text-blue-900 hover:text-blue-500 focus:outline-none focus:shadow-outline transition ease-in-out duration-150"
                          target="_blank"
                        >Get Access</a>
                      </div>
                    </div>
                  ...
                  >
                    <ul>
                      <li class="flex items-start">
                        ...
                        <p class="ml-3 text-base leading-6 font-medium text-gray-500">50 bids</p>
                      </li>
                      <li class="mt-4 flex items-start">
                        <div class="flex-shrink-0">
                          <svg
                        ...
                        <p class="ml-3 text-base leading-6 font-medium text-gray-500">100 skills</p>
                      </li>
                      <li class="mt-4 flex items-start">
                        <div class="flex-shrink-0">
                          <svg
                        ...
                        <p class="ml-3 text-base leading-6 font-medium text-gray-500">5 featured</p>
                      </li>
                    </ul>
                    <div class="mt-8">
                      <div class="border-2 border-blue-900 rounded-lg shadow-md">
                  ...
                  >
                    <ul>
                      ...
                      <li class="mt-4 flex items-start">
                        ...
                        <p class="ml-3 text-base leading-6 font-medium text-gray-500">2 featured</p>
                      </li>
                    </ul>
                    <div class="mt-8">
                      <div class="border-2 border-blue-900 rounded-lg shadow-md">
